  ...
  return (
	...
	<div class="container px-5 py-20 mx-auto">
	  <div class="flex flex-col text-center w-full mb-6">
		 <h1 class="sm:text-7xl text-4xl font-extrabold title-font mb-8 text-gray-900 tracking-widest">Sign<span className='text-white'>Up </span></h1>
	  ...
	  <div class="lg:w-1/2 md:w-2/3 mx-auto ">
		 <div class="flex flex-wrap -m-2">
			...
			<div class="p-4 w-1/2">
			  <div class="relative">
				 <label for="email" class="leading-7 text-1xl font-semibold text-gray-600">Email</label>
			...
			<div className="relative px-10 xl:px-0 container mx-auto md:flex items-center gap-8 pb-3">
				 ...
				 <p class="lg:w-2/3 mx-auto leading-relaxed text-2xl font-semibold pb-3 text-center">You have account ? <a href='' onClick={() => navigate("/logIn")} className='font-mono text-red-800 '>Log in </a></p>
		 </div>
